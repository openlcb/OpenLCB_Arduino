...
${OBJECTDIR}/EEPROM.o: EEPROM.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I../OlcbCommonCAN -I. -I../../gtest/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/EEPROM.o EEPROM.cpp

${OBJECTDIR}/BG.o: BG.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I../OlcbCommonCAN -I. -I../../gtest/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/BG.o BG.cpp

${OBJECTDIR}/OpenLcbCanInterface_local.o: OpenLcbCanInterface_local.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I../OlcbCommonCAN -I. -I../../gtest/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/OpenLcbCanInterface_local.o OpenLcbCanInterface_local.cpp

${OBJECTDIR}/OpenLcbCanInterface.o: OpenLcbCanInterface.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I../OlcbCommonCAN -I. -I../../gtest/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/OpenLcbCanInterface.o OpenLcbCanInterface.cpp

${OBJECTDIR}/Arduino.o: Arduino.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I../OlcbCommonCAN -I. -I../../gtest/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/Arduino.o Arduino.cpp

${OBJECTDIR}/ButtonLed.o: ButtonLed.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I../OlcbCommonCAN -I. -I../../gtest/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/ButtonLed.o ButtonLed.cpp

${OBJECTDIR}/ButtonProtocol.o: ButtonProtocol.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I../OlcbCommonCAN -I. -I../../gtest/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/ButtonProtocol.o ButtonProtocol.cpp
