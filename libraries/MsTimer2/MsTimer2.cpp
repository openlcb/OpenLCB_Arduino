/*
  ...
  History:
  	01/Sep/12 - V0.7 added support for AT90CAN128, AT90CAN64, AT90CAN32 Alex Shepherd (kiwi64ajs@sourceforge.net)
...
#elif defined (__AVR_AT90CAN128__) || defined (__AVR_AT90CAN64__) || defined (__AVR_AT90CAN32__)
	TIMSK2 &= ~(1<<TOIE2);
	TCCR2A &= ~((1<<WGM21) | (1<<WGM20));
	ASSR &= ~(1<<AS2);
	TIMSK2 &= ~(1<<OCIE2A);
