...
#include <SPI.h>
#endif
// Alternate Ethernet2 library for modified CAN-compatible shield
#include <Ethernet.h>
// DCHP service
...
void setup()
{
  ...
  // Ethernet start DHCP (should wait for complete)
  ...
  // start Bonjour (see http://gkaindl.com/software/arduino-ethernet/bonjour)
...
void loop()
{
  EthernetBonjour.run(); // for Bonjour
  EthernetDHCP.maintain(); // for DHCP
